...
description: Deep dive into the internal design and deployment pipeline of Atlas.
---

import { Tree } from "@umami/shiso/components";
...
<Tree>
  <Tree.Folder name="atlas" defaultOpen>
    <Tree.Folder name="cmd" defaultOpen>
      <Tree.Folder name="atlas" defaultOpen>
        <Tree.File name="main.go" />
        <Tree.Folder name="cmd" defaultOpen>
          <Tree.File name="root.go" />
          <Tree.File name="deploy.go" />
          <Tree.File name="debug.go" />
          <Tree.File name="testllm.go" />
          <Tree.File name="providers.go" />
          <Tree.File name="models.go" />
        </Tree.Folder>
      </Tree.Folder>
    </Tree.Folder>
    <Tree.Folder name="internal">
      <Tree.Folder name="config" />
      <Tree.Folder name="credentials" />
      <Tree.Folder name="workspace" />
      <Tree.Folder name="session" />
      <Tree.Folder name="state" />
      <Tree.Folder name="build" />
      <Tree.Folder name="detector" />
      <Tree.Folder name="tools" />
      <Tree.Folder name="llm" />
      <Tree.Folder name="deploy" />
      <Tree.Folder name="orchestrator" />
      <Tree.Folder name="registry" />
      <Tree.Folder name="healthcheck" />
      <Tree.Folder name="audit" />
      <Tree.Folder name="cliutil" />
      <Tree.Folder name="version" />
    </Tree.Folder>
    <Tree.Folder name="skills">
      <Tree.File name="fix_build.md" />
    </Tree.Folder>
    <Tree.Folder name="docs">
      <Tree.File name="ARCHITECTURE.md" />
      <Tree.File name="COMMANDS.md" />
    </Tree.Folder>
  </Tree.Folder>
</Tree>
